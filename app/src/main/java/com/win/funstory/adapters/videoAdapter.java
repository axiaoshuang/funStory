...
public class videoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(video_item.getUsername()!=null){
            holder.name.setText(video_item.getUsername());
            Picasso.with(context).load(getIconURL(video_item.getUserId(),video_item.getUserIcon()))
        ...
        holder.content.setText(video_item.getContent());
        holder.up.setText("好笑:"+video_item.getUp());
        holder.comments_count.setText("评论:"+video_item.getComments_count()+"");
        holder.share_count.setText("分享:"+video_item.getShare_count()+"");
    ...
    public void addAll(Collection<? extends Video_item> collection){
