...
/**
 * author：WangShuang
 * Date: 2015/12/30 12:16
 * email：m15046658245_1@163.com
 */
public class zuiAdapter  extends BaseAdapter {

    private Context context;
    private List<zuiXItem> list;

    public zuiAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.item_zuixin,parent,false);
            convertView.setTag(new ViewHolder(convertView));
        }

        zuiXItem item=list.get(position);
    ...
    public void addAll(Collection<? extends zuiXItem> collection){
